...
/**
  * The bmap service interface.
  * <p>
  * This describes everything that Lagom needs to know about how to serve and
  * consume the BmapService.
  */
trait BmapService extends Service {
  ...
  def findAllBuses(): ServiceCall[NotUsed, List[String]]
  ...
  override final def descriptor: Descriptor = {
    ...
    named("bmap")
      .withCalls(
        ...
        pathCall("/api/buses", findAllBuses _),
        pathCall("/api/buses/:id", findBusPosition _),
        pathCall("/api/lines/:id", findLinePosition _)
      )
      .withTopics(
        topic(BmapService.TOPIC_NAME, greetingsTopic _)
